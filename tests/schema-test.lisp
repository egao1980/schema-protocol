...
(deftest format-backends-are-optional
  ...
  (let ((e (handler-case (emit-schema 'schema-object :format :avro)
             (schema-unknown-format (c) c))))
    (ok (typep e 'schema-unknown-format))
    (ok (eq :avro (schema-unknown-format-format e)))))
